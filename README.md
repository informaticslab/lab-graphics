# PHIResearchLab.org lab-graphics

Holding repository for graphical and design elements used for R&D purchases.

## Goals
To store graphical elements that can be used within the public health informatics community.
